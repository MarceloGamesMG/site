    ...
    return (
        <div id='baependi' className="flex flex-col justify-center items-center w-[320px] md:w-[1000px] pt-20 pb-20">
            ...
            <p className='text-center md:text-start'>
                ...
                A grande atração religiosa da cidade é Nhá Chica. A “Santa de Baependi”, Beatificada em 04 de maio deste ano, atraiu milhares de peregrinos à cidade para esta tão esperada data. O Santuário Nossa Senhora da Conceição, que guarda a urna com seus restos mortais, a Casa onde viveu a Beata e o Memorial Nhá Chica, são locais de grande peregrinação e oração de devotos, que vem pedir e agradecer as Graças alcançadas; atingindo maior intensidade de turistas e romeiros na comemoração do Dia de Imaculada Conceição (8 de dezembro). A Festa de Nossa Senhora de Montserrat (8 de setembro), padroeira da cidade, também é realizada com grande participação popular.<br />

                População:19.000 habitantes (Aproximado).
                ...
                – Dia da Morte de Nhá Chica e Comemoração da Beatificação de Nhá Chica: 14 de junho<br />

                – Dia da Padroeira Nossa Senhora de Montserrat: 08 de setembro<br />
